...
CREATE TABLE IF NOT EXISTS bl_dm.dim_products (
    ...
    CONSTRAINT uq_dim_products_src_id UNIQUE (product_src_id)
);
...
CREATE TABLE IF NOT EXISTS bl_dm.dim_stores (
    ...
    CONSTRAINT uq_dim_stores_src_id UNIQUE (store_src_id)
);
...
CREATE TABLE IF NOT EXISTS bl_dm.dim_payments (
    ...
    CONSTRAINT uq_dim_payments_src_id UNIQUE (payment_src_id)
);
...
CREATE TABLE IF NOT EXISTS bl_dm.dim_deliveries (
    ...
    CONSTRAINT uq_dim_deliveries_src_id UNIQUE (delivery_src_id)
);
