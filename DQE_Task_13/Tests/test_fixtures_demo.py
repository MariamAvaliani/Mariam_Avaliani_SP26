"""
Fixture scope lesson (from Task 11): module-scoped autouse fixture for
suite timing, function-scoped fixture for per-test timing. Kept exactly as
originally written - these two fixtures live here, not in the shared
conftest.py, on purpose (see the note at the top of conftest.py).
"""
